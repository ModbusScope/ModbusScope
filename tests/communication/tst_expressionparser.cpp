...
void TestExpressionParser::singleRegister()
{
    ...
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, Connection::ID_1, "16b");
...
void TestExpressionParser::singleRegisterConn()
{
    ...
    auto expExpressions = QStringList() <<  "r(0      )";
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, Connection::ID_2, "16b");
...
void TestExpressionParser::singleRegisterSigned()
{
    ...
    auto expExpressions = QStringList() <<  "r(0          )";
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, Connection::ID_1, "s16b");
...
void TestExpressionParser::singleRegisterSigned32()
{
    ...
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, Connection::ID_1, "s32b");
...
void TestExpressionParser::singleRegisterConnType()
{
    ...
    auto expExpressions = QStringList() <<  "r(0            )";
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, Connection::ID_2, "s32b");
...
void TestExpressionParser::multiRegisters()
{
    ...
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, Connection::ID_1, "16b")
                                                      << ModbusRegister(45333, Connection::ID_1, "16b")
                                                      << ModbusRegister(45334, Connection::ID_1, "16b");
...
void TestExpressionParser::failureMulti()
{
    ...
    auto expExpressions = QStringList() <<  "${}" << "r(0    )";
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45331, Connection::ID_1, "16b");
...
void TestExpressionParser::combinations()
{
    ...
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, Connection::ID_2, "s32b")
                                                      << ModbusRegister(45330, Connection::ID_1, "16b");
...
void TestExpressionParser::explicitDefaults()
{
    ...
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(40001, Connection::ID_1, "16b")
...
void TestExpressionParser::spaces()
{
    ...
    auto expExpressions = QStringList() <<  "r(0                 ) + r(1        )";
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, Connection::ID_2, "32b")
                                                      << ModbusRegister(45330, Connection::ID_1, "16b");
...
void TestExpressionParser::manyRegisters()
{
    auto input = QStringList() << "${0}" << "${1}"
                                ...
                                << "${8}" << "${9}"
                                << "${10}" << "${11}";
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(0, Connection::ID_1, "16b")
                                                        << ModbusRegister(1, Connection::ID_1, "16b")
                                                        << ModbusRegister(2, Connection::ID_1, "16b")
                                                        << ModbusRegister(3, Connection::ID_1, "16b")
                                                        << ModbusRegister(4, Connection::ID_1, "16b")
                                                        << ModbusRegister(5, Connection::ID_1, "16b")
                                                        << ModbusRegister(6, Connection::ID_1, "16b")
                                                        << ModbusRegister(7, Connection::ID_1, "16b")
                                                        << ModbusRegister(8, Connection::ID_1, "16b")
                                                        << ModbusRegister(9, Connection::ID_1, "16b")
                                                        << ModbusRegister(10, Connection::ID_1, "16b")
                                                        << ModbusRegister(11, Connection::ID_1, "16b");
    auto expExpressions = QStringList() << "r(0)" << "r(1)"
                                        << "r(2)" << "r(3)"
                                        << "r(4)" << "r(5)"
                                        << "r(6)" << "r(7)"
