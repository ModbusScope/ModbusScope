...
void TestExpressionParser::singleRegisterSigned()
{
    ...
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, SettingsModel::CONNECTION_ID_1, false, false);
    auto expExpressions = QStringList() << "regval(0)";
...
void TestExpressionParser::multiRegisters()
{
    ...
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, SettingsModel::CONNECTION_ID_1, false, true)
                                                      << ModbusRegister(45333, SettingsModel::CONNECTION_ID_1, false, true)
                                                      << ModbusRegister(45334, SettingsModel::CONNECTION_ID_1, false, true);
...
void TestExpressionParser::failureMulti()
{
    ...
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45331, SettingsModel::CONNECTION_ID_1, false, true);
    auto expExpressions = QStringList() << "" << "regval(0)";
...
void TestExpressionParser::combinations()
{
    ...
    auto expModbusRegisters = QList<ModbusRegister>() << ModbusRegister(45332, SettingsModel::CONNECTION_ID_2, true, false)
                                                      << ModbusRegister(45330, SettingsModel::CONNECTION_ID_1, false, true);
