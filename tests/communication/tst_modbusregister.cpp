...
void TestModbusRegister::description()
{
    ...
    QCOMPARE(reg_1.description(), "holding register, 0, unsigned 16-bit, device id 1");
    QCOMPARE(reg_2.description(), "holding register, 1, signed 32-bit, device id 2");
    QCOMPARE(reg_3.description(), "holding register, 2, 32-bit float, device id 2");
}
